  ...
  return (
    <div>
      ...
      <Card.Group id="about-cards" itemsPerRow={3}>
        <Card>
          ...
          <Card.Content textAlign="center">
            ...
            <Card.Description>
              ...
              <br />
              as well as an avid hearthstone player
            </Card.Description>
            <Menu.Item
        ...
        <Card>
          <img height={400} src="./images/zion-about.jpg" wrapped ui={false} />
          <Card.Content textAlign="center">
        ...
        <Card>
          <img height={400} src="./images/tommy-about.png" wrapped ui={false} />
          <Card.Content textAlign="center">
            ...
            <Menu.Item href="https://github.com/Gnomedealer" position="right" target="_blank">
              <Icon name="github" size="big" />
            </Menu.Item>
            <Menu.Item
